    ...
    return (
      <div>
        <div className='student-course-nav-bar'>
            <button onClick={handleHomeClick} className={view === "home" ? "selected" : "not-selected"} style={{ margin: '5px' }}>
                Course Home
            </button>
            <button onClick={handleExamsClick} className={view === "exams" ? "selected" : "not-selected"}style={{ margin: '5px' }}>
                Exams
            </button>
        </div>
